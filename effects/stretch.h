...
/* Produces audio time-stretching (only speeds up), not changing sound pitch.
   ...
   Algorithm based on that number of unclaimed samples in the chunk is less than or equals number of staying samples,
   so number of samples in chunk must be at most greater than number of staying samples in 2 times.
