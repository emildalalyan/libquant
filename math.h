...
/* Find intermediate value of the function with interpolation.
   ...
   y0 - is beginning value.
   y1 - is ending value.
   pos - is the position of desired value between beginning and ending values. 
   You can calculate it using following formula: (x-x0)/(x1-x0),
   where x - is coordinate of desired value, and
   x0, x1 - is coordinates of beginning and ending values respectively. */
...
/* Calculate logarithm of the number to specified base.
   ...
   Base cannot be 1, 0, or negative number. */
